        ...
        <div className="mx-auto flex flex-col gap-4 px-4 py-4 md:px-6 lg:px-8">
          ...
          <nav className="grid grid-cols-2 sm:grid-cols-5 gap-2">
            <Button asChild variant="ghost" size="sm" className="rounded-md text-xs font-medium">
              <Link to="/dashboard" activeProps={{ className: "bg-slate-950 text-white" }}>
                Dashboard
              </Link>
            </Button>
            <Button asChild variant="ghost" size="sm" className="rounded-md text-xs font-medium">
              <Link to="/projetos" activeProps={{ className: "bg-slate-950 text-white" }}>
                Meus Projetos
              </Link>
            </Button>
            <Button asChild variant="ghost" size="sm" className="rounded-md text-xs font-medium">
              <Link to="/financeiro" activeProps={{ className: "bg-slate-950 text-white" }}>
                Financeiro
              </Link>
            </Button>
            <Button asChild variant="ghost" size="sm" className="rounded-md text-xs font-medium">
              <Link to="/documentos" activeProps={{ className: "bg-slate-950 text-white" }}>
                Contratos
              </Link>
            </Button>
            <Button asChild variant="ghost" size="sm" className="rounded-md text-xs font-medium">
              <Link to="/suporte" activeProps={{ className: "bg-slate-950 text-white" }}>
                Suporte
              </Link>
            </Button>
          </nav>
